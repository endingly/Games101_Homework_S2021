...
{
    // TODO [done]: Implement this function to check if the point (x, y) is inside the triangle
...
void rst::rasterizer::rasterize_triangle(const Triangle& t)
{
    ...
    // TODO [done]: Find out the bounding box of current triangle.
    ...
    for (int y = min_y; y < max_y; y++)
    {
        for (int x = min_x; x < max_x; x++)
        {
            ...
            if (insideTriangle(x + 0.5, y + 0.5, t.v))
            {
                ...
                // TODO [done]: set the current pixel (use the set_pixel function) to the color of the
